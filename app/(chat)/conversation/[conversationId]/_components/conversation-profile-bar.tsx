    ...
    return (
        <div className="sm:flex justify-end overflow-y-hidden h-full drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.2)] hidden ">
            <div className="bg-[#090909]/05 w-[420px] border-2 border-black ">
                ...
                <div className="mt-2">
                    <div className="flex justify-center text-gray-900/80 font-medium text-sm">
                ...
                <div className="flex justify-center mt-2 gap-x-12">
                    <div className="">
                        <Button variant="ghost" className="bg-white border-gray-400 border">
                            <UserCircle />
                        </Button>
                    </div>
                    <div className="">
                ...
                <div>
                    <div className="ml-4 mt-4">
                        <div className="font-semibold flex p-4 bg-white mr-4 rounded-md">
