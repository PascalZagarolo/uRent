                    ...
                    <div className="  min-h-screen">
                        <div className="p-4 mt-4  rounded-lg ">
                            <h3 className="dark:text-gray-100 text-2xl font-semibold flex items-center">
                                 uRent - Datenschutzerklärung <p className="ml-auto text-sm"> (01.01.2024) </p>
                            </h3>
                        </div>
                        ...
                        <div className="p-8 text-sm dark:text-gray-300/90">
                            ...
                            <div className="p-4 mt-8">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Die Internetseiten der uRent verwenden Cookies. Cookies sind Textdateien, welche
                                    ...
                                    <p className="mt-2">
                                        Durch den Einsatz von Cookies kann die uRent den Nutzern dieser Internetseite
                                ...
                                <div>
                                    ...
                                    <p>
                                        Die Internetseite der uRent erfasst mit jedem Aufruf der Internetseite durch eine
                                        ...
                                        Datum und die Uhrzeit eines Zugriffs auf die Internetseite, (6) eine Internet-Protokoll
                                        Adresse (IP-Adresse), (7) der Internet-Service-Provider des zugreifenden Systems
                                    ...
                                    <p className="mt-2">
                                        Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die uRent keine
                                        ...
                                        uRent daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
                                ...
                                <div>
                                    ...
                                    <p>
                                        Auf der Internetseite der uRent wird den Benutzern die Möglichkeit eingeräumt, den
                                        Newsletter unseres Unternehmens zu abonnieren. Welche personenbezogenen
                                    ...
                                    <p className="mt-2">
                                        Die uRent informiert ihre Kunden und Geschäftspartner in regelmäßigen Abständen
                                        im Wege eines Newsletters über Angebote des Unternehmens. Der Newsletter
                                        unseres Unternehmens kann von der betroffenen Person grundsätzlich nur dann
                                        empfangen werden, wenn (1) die betroffene Person über eine gültige E-Mail-Adresse
                                        verfügt und (2) die betroffene Person sich für den Newsletterversand registriert. An
                                        die von einer betroffenen Person erstmalig für den Newsletterversand eingetragene
                                        E-Mail-Adresse wird aus rechtlichen Gründen eine Bestätigungsmail im Double-Opt
                                        In-Verfahren versendet. Diese Bestätigungsmail dient der Überprüfung, ob der
                                        Inhaber der E-Mail-Adresse als betroffene Person den Empfang des Newsletters
                                        autorisiert hat.
                                    </p>
                                    <p className="mt-2">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Die Newsletter der uRent enthalten sogenannte Zählpixel. Ein Zählpixel ist eine
                                        ...
                                        eingebetteten Zählpixels kann die uRent erkennen, ob und wann eine E-Mail von
                                        einer betroffenen Person geöffnet wurde und welche in der E-Mail befindlichen Links
                                    ...
                                    <p className="mt-2">
                                        ...
                                        Newsletters deutet die uRent automatisch als Widerruf.
                                    </p>
                                ...
                                <div>
                                    ...
                                    <p>
                                        Die uRent bietet den Nutzern auf einem Blog, der sich auf der Internetseite des für
                                        die Verarbeitung Verantwortlichen befindet, die Möglichkeit, individuelle Kommentare
                                        zu einzelnen Blog-Beiträgen zu hinterlassen. Ein Blog ist ein auf einer Internetseite
                                        geführtes, in der Regel öffentlich einsehbares Portal, in welchem eine oder mehrere
                                        Personen, die Blogger oder Web-Blogger genannt werden, Artikel posten oder
                                        Gedanken in sogenannten Blogposts niederschreiben können. Die Blogposts können
                                        in der Regel von Dritten kommentiert werden.
                                    </p>
                                    <p className="mt-2">
                                        Hinterlässt eine betroffene Person einen Kommentar in dem auf dieser Internetseite
                                        veröffentlichten Blog, werden neben den von der betroffenen Person hinterlassenen
                                        Kommentaren auch Angaben zum Zeitpunkt der Kommentareingabe sowie zu dem
                                        von der betroffenen Person gewählten Nutzernamen (Pseudonym) gespeichert und
                                        veröffentlicht. Ferner wird die vom Internet-Service-Provider (ISP) der betroffenen
                                        Person vergebene IP-Adresse mitprotokolliert. Diese Speicherung der IP-Adresse
                                        erfolgt aus Sicherheitsgründen und für den Fall, dass die betroffene Person durch
                                        einen abgegebenen Kommentar die Rechte Dritter verletzt oder rechtswidrige Inhalte
                                        postet. Die Speicherung dieser personenbezogenen Daten erfolgt daher im eigenen
                                        Interesse des für die Verarbeitung Verantwortlichen, damit sich dieser im Falle einer
                                        ...
                                        Weitergabe nicht gesetzlich vorgeschrieben ist oder der Rechtsverteidigung des für
                                ...
                                <div>
                                    ...
                                    <p>
                                        Die im Blog der uRent abgegebenen Kommentare können grundsätzlich von Dritten
                                        abonniert werden. Insbesondere besteht die Möglichkeit, dass ein Kommentator die
                                        seinem Kommentar nachfolgenden Kommentare zu einem bestimmten Blog-Beitrag
                                        abonniert.
                                    </p>
                                    <p className="mt-2">
                                        Sofern sich eine betroffene Person für die Option entscheidet, Kommentare zu
                                        abonnieren, versendet der für die Verarbeitung Verantwortliche eine automatische
                                        Bestätigungsmail, um im Double-Opt-In-Verfahren zu überprüfen, ob sich wirklich der
                                        Inhaber der angegebenen E-Mail-Adresse für diese Option entschieden hat. Die
                                ...
                                <div>
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold">  a)    Recht auf Bestätigung </p>
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold">  b)    Recht auf Auskunft   </p>
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> c)    Recht auf Berichtigung </p>
                                        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> d)    Recht auf Löschung (Recht auf Vergessen werden)   </p>
                                        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                        ...
                                        <div className="p-4">
                                            <p>
                                                o Die personenbezogenen Daten wurden für solche Zwecke erhoben
                                            ...
                                            <p>
                                                o Die personenbezogenen Daten wurden in Bezug auf angebotene
                                        ...
                                        <p className="mt-2">
                                            ...
                                            die Löschung von personenbezogenen Daten, die bei der uRent gespeichert
                                            sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter
                                            des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der uRent
                                            wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
                                            wird.
                                        </p>
                                        <p className="mt-2">
                                            Wurden die personenbezogenen Daten von der uRent öffentlich gemacht und
                                            ist unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur
                                            Löschung der personenbezogenen Daten verpflichtet, so trifft die uRent unter
                                            ...
                                            erforderlich ist. Der Mitarbeiter der uRent wird im Einzelfall das Notwendige
                                            veranlassen.
                                        </p>
                                    </div>

                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> e)    Recht auf Einschränkung der Verarbeitung   </p>
                                        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                        ...
                                        <p className="mt-2">
                                            ...
                                            der uRent gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit
                                            an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
                                            Mitarbeiter der uRent wird die Einschränkung der Verarbeitung veranlassen.
                                        </p>
                                    </div>

                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> f)     Recht auf Datenübertragbarkeit    </p>
                                        <p className="">
                                            Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                            das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                            ...
                                            wurden, zu übermitteln, sofern die Verarbeitung auf der Einwilligung gemäß
                                            Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO
                                            oder auf einem Vertrag gemäß Art. 6 Abs. 1 Buchstabe b DS-GVO beruht und
                                        ...
                                        <p className="mt-2">
                                            ...
                                            betroffene Person jederzeit an einen Mitarbeiter der uRent wenden.
                                        </p>
                                    </div>

                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> g)    Recht auf Widerspruch    </p>
                                        <p>
                                            Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                            das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                        ...
                                        <p className="mt-2">
                                            Die uRent verarbeitet die personenbezogenen Daten im Falle des
                                        ...
                                        <p className="mt-2">
                                            Verarbeitet die uRent personenbezogene Daten, um Direktwerbung zu
                                            ...
                                            gegenüber der uRent der Verarbeitung für Zwecke der Direktwerbung, so wird
                                            die uRent die personenbezogenen Daten nicht mehr für diese Zwecke
                                            verarbeiten.
                                        </p>
                                        <p className="mt-2">
                                            ...
                                            personenbezogener Daten, die bei der uRent zu wissenschaftlichen oder
                                        ...
                                        <p className="mt-2">
                                            ...
                                            direkt an jeden Mitarbeiter der uRent oder einen anderen Mitarbeiter wenden.
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> h)    Automatisierte Entscheidungen im Einzelfall einschließlich Profiling     </p>
                                        <p>
                                            Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                            das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
                                        ...
                                        <p className="mt-2">
                                            ...
                                            (2) erfolgt sie mit ausdrücklicher Einwilligung der betroffenen Person, trifft die
                                            uRent angemessene Maßnahmen, um die Rechte und Freiheiten sowie die
                                    ...
                                    <div className="p-4">
                                        <p className="mb-2 font-semibold"> i)      Recht auf Widerruf einer datenschutzrechtlichen Einwilligung      </p>
                                        <p>
                                            Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
                                            das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
