    ...
    return ( 
        <div>
            ...
            <div className="mt-4 flex flex-col space-y-32">
                ...
                <div>
                    <div className="sm:text-right text-left text-xl font-semibold">
                    ...
                    <div className="mt-4 sm:w-1/2 w-full text-gray-200/80 ml-auto">
                ...
                <div>
                    ...
                    <div className="mt-4 sm:w-1/2 w-full text-gray-200/80">
