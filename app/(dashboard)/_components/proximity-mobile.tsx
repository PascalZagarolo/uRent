...
const ProximityMobile = () => {
  ...
  return ( 
    ...
    >
      <SelectTrigger className="w-full h-10 bg-[#1B1F2C]/90 hover:bg-[#252a3d] text-gray-200 text-sm font-medium border-none rounded-r-md transition-all duration-200 focus:ring-1 focus:ring-indigo-500/60 shadow-md">
...
export default ProximityMobile;