...
const MietenCityLkwPage = ({ params }: MietenCityLkwProps) => {
  const { city } = params;
  const category = "lkw";
  ...
  return (
    <div className="bg-gradient-to-b from-[#14151b] to-[#1a1c25] min-h-screen">
      ...
      <Script id="structured-data-lkw" type="application/ld+json" strategy="afterInteractive">
...
export default MietenCityLkwPage;

export async function generateMetadata({ params }: MietenCityLkwProps) {
