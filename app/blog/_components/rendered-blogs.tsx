    ...
    <div>
      ...
      >
        ...
        <div className="mt-6">
          ...
          <p className="text-sm text-gray-400 mt-2 line-clamp-3"
            dangerouslySetInnerHTML={{ __html: foundBlogs[0]?.content }}
          >
      ...
      <div className="grid grid-cols-2 w-full mt-4">
        {foundBlogs.slice(1, foundBlogs.length).map((blog, index) => (
          <div key={index} className="w-full bg-[#242424] shadow-lg">
            <div>
              <img
                src={blog.imageUrl}
                alt="blog image"
                width={200}
                height={200}
                className="rounded-lg rounded-b-none h-40 object-cover w-full"
              />
            </div>

            <div className="mt-2 bg">
              <div>
                <h3 className="text-base font-semibold text-gray-200  line-clamp-1">
                  {blog.title}
                </h3>
              </div>
            </div>
