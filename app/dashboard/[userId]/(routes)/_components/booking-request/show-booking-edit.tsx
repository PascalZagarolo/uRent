...
import SelectTimeRange from "../../manage/_components/select-time-range";



interface ShowBookingEditProps {
    foundInserate: typeof inserat.$inferSelect[]
}


const ShowBookingEdit: React.FC<ShowBookingEditProps> = ({
    foundInserate
}) => {
...
export default ShowBookingEdit;