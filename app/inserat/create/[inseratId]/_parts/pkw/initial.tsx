...
const InitialForm: React.FC<InitialFormProps> = ({
    ...
    const [currentInitial, setcurrentInitial] = useState<Date | null>(inital || new Date);
    ...
    const handleInputChange = (event) => {
        ...
        if(validValue) {
            ...
            setcurrentInitial(new Date(newInitial));
        }
    };
        ...
        <div className="flex mt-4 w-full">
            <div className="items-center">
                ...
                <Input
                    ...
                    value={inputValue || format(new Date(currentInitial), "MM/yyyy")}
