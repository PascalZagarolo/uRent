...
interface TransportLoadingVolumeFormProps {
    thisVolume: number;
}

const TransportLoadingVolumeForm: React.FC<TransportLoadingVolumeFormProps> = ({
    thisVolume
}) => {
...
export default TransportLoadingVolumeForm;