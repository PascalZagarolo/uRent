...
const TrailerSeatsSearch = () => {
    const currentObject: any = useSavedSearchParams((state) => state.searchParams);
    const [currentSeats, setCurrentSeats] = useState(currentObject["trailerSeats"]);
    const [currentMaxSeats, setCurrentMaxSeats] = useState(currentObject["trailerSeatsMax"]);
    ...
    const onSubmitStart = (selectedValue: string) => {
        ...
        changeSearchParams("trailerSeats", selectedValue);
    }
    ...
    const onSubmitEnd = (selectedValue: string) => {
        ...
        changeSearchParams("trailerSeatsMax", selectedValue);
    }
    ...
    useEffect(() => {
        if (currentSeats && currentMaxSeats) {
            if (Number(currentSeats) > Number(currentMaxSeats)) {
                changeSearchParams("trailerSeatsMax", currentSeats);
    ...
    useEffect(() => {
        if (currentSeats && currentMaxSeats) {
            if (Number(currentSeats) > Number(currentMaxSeats)) {
                changeSearchParams("trailerSeats", currentMaxSeats);
    ...
    const deleteSeats = () => {
        ...
        deleteSearchParams("trailerSeats");
    }

    const deleteSeatsEnd = () => {
        setCurrentMaxSeats(null);
        deleteSearchParams("trailerSeatsMax");
    }
...
export default TrailerSeatsSearch; 