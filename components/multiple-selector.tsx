        ...
        >
          <div className="flex flex-wrap gap-1">
              ...
              return (
                <Badge
                  ...
                  className={cn(
                    ...
                    'bg-[#1B1F2C] text-gray-100 hover:bg-[#232838]',
                    badgeClassName,
                  )}
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'p-1 flex-1 bg-transparent outline-none placeholder:text-muted-foreground',
                        ...
                        {dropdowns.map((option) => {
                          return (
                            ...
                            className={cn(
                              ...
                              option.disable && ' text-muted-foreground hover: cursor-pointer',
                            )}
                          >
                            <div>
                            {option.label} 
