...
import { Inter } from "next/font/google";
  ...
  export const SubscriptionAlmostExpired = () => (
    <Html>
      <Head />
      <Preview>Dein uRent Abo läuft ab</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            wir wollten dir mitteilen, dass dein uRent Abo in naher Zukunft abläuft.
            Um weiterhin alle Vorteile, deines Abonnements nutzen zu können, verlängere es nach Vertragsablauf.
  ...
  export default SubscriptionAlmostExpired;
