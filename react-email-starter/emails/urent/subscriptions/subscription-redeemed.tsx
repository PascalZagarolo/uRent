...
import { Inter } from "next/font/google";
  ...
  export const SubscriptionRedeemed = () => (
    <Html>
      <Head />
      <Preview>Glückwunsch! Dein Abonnement wurde erfolgreich eingelöst</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            Du hast erfolgreich dein Abonnement eingelöst und kannst jetzt alle Vorteile nutzen. <br/>
            Nehme dir Zeit und entdecke die vielen Möglichkeiten, die uRent dir bietet. <br/> 
            Weiteres zu deinem Abonnement findest du in deinem Dashboard unter {`"`}Zahlungsverkehr{`"`}. <br/> <br/>
  ...
  export default SubscriptionRedeemed;
