...
import { Inter } from "next/font/google";
  ...
  export const SubscriptionUpgraded = () => (
    <Html>
      <Head />
      <Preview>Dein Abonnement wurde geändert</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            Wir wollten dir mitteilen, dass dein uRent erfolgreich geändert wurde. <br/>
            Dein neues Abo wird ab sofort aktiviert und du kannst alle Vorteile deines gewählten Pakets nutzen. <br/>
            Dein Abrechnungszeitraum bleibt gleich.
            <br/> 
            Weiteres zu deinem neuem Abonnement sowie die neue Rechnung findest du in deinem Dashboard unter {`"`}Zahlungsverkehr{`"`}. <br/> <br/>
